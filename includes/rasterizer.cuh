...
namespace gs {
    ...
    public:
        ...
        static std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor> Backward(SaveForBackward saveForBackward, torch::Tensor g_color) {
            ...
            //            if (torch::equal(imgBuffer_rasterizer_cuh, saveForBackward.imgBuffer)) {
            //                std::cout << "\n================imgBuffer_rasterizer_cuh and saveForBackward.imgBuffer are equal!================\n" << std::endl;
            //            } else {
            //                std::cout << "=================imgBuffer_rasterizer_cuh and saveForBackward.imgBuffer are NOT equal!====================" << std::endl;
            //            }
            //
            //            if (torch::equal(imgBuffer_rasterizer_cuh, imgBuffer)) {
            //                std::cout << "\n================imgBuffer_rasterizer_cuh and imgBuffer are equal!================\n" << std::endl;
            //            } else {
            //                std::cout << "=================imgBuffer_rasterizer_cuh and imgBuffer are NOT equal!====================" << std::endl;
            //            }
            //                torch::Tensor imgBuffer_rasterizer_cuh, binningBuffer_rasterizer_cuh;
